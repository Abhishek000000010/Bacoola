      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden flex flex-col" data-testid="order-details-container">
        ...
        <div className="bg-gray-50 border-b border-gray-200 p-6 flex flex-wrap gap-8 items-center justify-between text-sm">
          <div className="flex flex-col gap-1">
            <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold">Order #</span>
            <span className="font-medium text-gray-900">{order.display_id}</span>
          </div>
          <div className="flex flex-col gap-1">
            <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold">Order Date</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold">Status</span>
            <span className="font-medium text-gray-900 bg-gray-200 px-3 py-1 rounded-full text-xs lg:text-sm">{formatStatus(order.status)}</span>
          </div>
          <div className="flex flex-col gap-1">
            <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold">Items</span>
            <span className="font-medium text-gray-900">{totalItems} {totalItems === 1 ? "Item" : "Items"}</span>
          </div>
          <div className="flex flex-col gap-1">
            <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold">Total Amount</span>
        ...
        <div className="bg-gray-50 border-t border-gray-200 p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex flex-col gap-1 text-sm">
              <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold mb-1">Shipping Address</span>
            ...
            <div className="flex flex-col gap-4 text-sm">
              <div className="flex flex-col gap-1">
                <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold mb-1">Contact</span>
              ...
              <div className="flex flex-col gap-1">
                <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold mb-1">Payment</span>
              ...
              <div className="flex flex-col gap-1">
                <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold mb-1">Shipping Method</span>
                <span className="text-gray-600 capitalize">
          ...
          <div className="flex flex-col text-sm border-t md:border-t-0 md:border-l border-gray-200 pt-6 md:pt-0 md:pl-8">
            <span className="text-gray-500 uppercase tracking-wider text-xs lg:text-sm font-semibold mb-4">Order Summary</span>
