  ...
  return (
    <div className="w-full max-w-[500px] mx-auto pt-0 font-sans text-[#111111]">
      ...
      <div className="flex flex-col items-center justify-center min-h-[300px] text-center bg-[#f9f9f9] p-8">
        <h2 className="text-[12px] lg:text-[14px] font-bold uppercase tracking-[0.05em] text-neutral-950 mb-3">
          No saved cards
        </h2>
        <p className="text-[12px] lg:text-[14px] font-normal text-neutral-800 mb-8 max-w-[300px] leading-relaxed">
